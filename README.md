...
module "ecr_credentials" {
  ...
  cronjob_image                 = "kamranbiglari/ecr-k8s-updater:v0.2.2"
...
| cronjob_image | Docker image for the credential refresh cronjob | `string` | `"kamranbiglari/ecr-k8s-updater:v0.2.2"` | no |
